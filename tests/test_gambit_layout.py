...
def _asymmetric_game(title="asym_game"):
    ...
    _set_outcome(g, ("Left", "Down"), [0, 1])
    _set_outcome(g, ("Right",), [2, 2])
    return g
...
class TestChanceNodes:
    def test_fractional_probability(self):
        ...
        _set_outcome(g, ("H", "B"), [0, 1])
        _set_outcome(g, ("T",), [2, 2])
...
class TestInformationSets:
    def test_iset_line_generated(self):
        ...
        for label in ("Left", "Right"):
            _set_outcome(g, (label, "Up"), [1, 0])
            _set_outcome(g, (label, "Down"), [0, 1])
    ...
    def test_iset_nodes_have_no_inline_player(self):
        ...
        _join_infoset(g, ("R",), ("L",))
        for label in ("L", "R"):
            _set_outcome(g, (label, "U"), [1, 0])
            _set_outcome(g, (label, "D"), [0, 1])
